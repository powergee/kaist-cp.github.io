...
During my undergraduate studies, I had the privilege of participating in the [rv6](https://github.com/kaist-cp/rv6) project and being supervised by [Prof. Jeehoon Kang]({{ site.baseurl }}/jeehoon.kang/).
